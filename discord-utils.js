...
/* Discord.Message.prototype.reply = function(content, msg_id){
      require('./reply').reply(this.client,this,content, msg_id || this.id)
        }*/
      /*  module.exports = {
          ...
          Discord.Message.prototype.reply = function(content, msg_id){
            ...
            if(msg_id && typeof msg_id !== "string") throw new Error("Veuillez mettre l'id sous forme de string")
...
//Discord.Message.prototype.resp = function(content, msg_id){
...
/*embed: function(message, {title, description}){
...
poll: function(message, {description, choice1, choice2, choice3, choice4, color}) {
  ...
  /*let optn = {
    choice3: 'choice3' in options ? options.choice3 : "", 
    choice4: 'choice4' in options ? options.choice4 : ""
  }*/
      const embed = new Discord.MessageEmbed()
      .setTitle("Sondage")
...
eval: async function(client, message, args, code) {
 ...
 // if(!evaluer) message.channel.send("Veuillez utiliser cette syntax: 'require(`discord-utils`).eval(message, <votre_code>)'")
 //console.log(`${evaluer}`)
